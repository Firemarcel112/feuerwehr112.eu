<div class="nav-item dropdown d-flex align-self-center">
	<span
		class="flag flag-country-@if(App::isLocale('en'))us @else{{ App::getLocale() }} @endif cursor-pointer"
		...
		<div class="list-group list-group-flush">
			@foreach ($sprachen as $sprache)
				<a href="?language={{ $sprache->getCode() }}" class="cursor-pointer list-group-item">
					<span
						class="flag flag-country-@if ($sprache->getCode() == 'en')us @else{{ $sprache->getCode() }} @endif"></span>
