...
<head>
	...
	<title>{{config('app.name')}} {{__('general.uebersetzung')}}</title>
...
<header class="navbar navbar-static-top navbar-inverse" id="top" role="banner">
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a href=" {{route('translations') }}" class="navbar-brand">
				Translation Manager
			</a>
			...
			@foreach($translations as $key => $translation)
				<tr id="<?php echo htmlentities($key, ENT_QUOTES, 'UTF-8', false) ?>">
					...
					<?php foreach ($locales as $locale): ?>
						...
						<td @if(is_null($translation[$locale]->value?? null))style="color: red; background-color: yellow"@endif>
							<a href="#edit"
